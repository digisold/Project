...
layuiXtree.prototype.dataBind = function (d) {
    ...
    if (d.length > 0) {
        for (i in d) {
            ...
            var checked = d[i].checked;
            _this._domStr += '<input type="checkbox" '+ (checked != null && checked != undefined && checked == true ? "checked" : "") +' class="layui-xtree-checkbox" ' + xtree_isend + ' value="' + d[i].value + '" title="' + d[i].title + '" lay-skin="primary" lay-filter="xtreeck">';
