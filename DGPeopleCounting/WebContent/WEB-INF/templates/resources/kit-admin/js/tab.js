    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="dg-icon">&#xe64c;</i> 实时概览</li>',
                    '</ul>',
                ...
                $that.off('click').on('click', function() {
                    ...
                    switch (target) {
                        ...
                        case 'closeCurrent': //关闭当前
                            ...
                            that._content.children('div[lay-item-id]').each(function() {
                             	var curId = $(this).attr('lay-item-id');
        ...
        tabAdd: function(options) {
            ...
            if (icon) {
                if (icon.indexOf('fa-') !== -1) {
                    ...
                    titleHtm.push('<i class="dg-icon">' + icon + '</i>');
                }
            }
            titleHtm.push('&nbsp;' + title);
