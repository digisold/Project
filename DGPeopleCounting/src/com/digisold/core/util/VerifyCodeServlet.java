...
public class VerifyCodeServlet extends HttpServlet {
	 ...
	 * VerifyCodeServlet
	 */
	private static final long serialVersionUID = 248780967165801077L;
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		// 设定字体
		g.setFont(new Font("Arial, Helvetica, sans-serif", Font.ROMAN_BASELINE, 22));
		...
		for (int i = 1; i <= 4; i++) {
			...
			verifyCode += strV;
			g.drawString(strV, (i == 1 ? 18 : i * 18), 25);
		}
